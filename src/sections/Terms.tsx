export default function Terms() {
  return (
    <div className="legal-content">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-3">2. User Obligations</h3>
      <p>
        You agree to use our Site and services only for lawful purposes and in a manner that does
        not infringe upon the rights of others. You agree to provide accurate and complete
        information when using our contact forms or engaging our services. You are prohibited from:
      </p>
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          Using any automated means, such as robots, spiders, or scrapers, to access the Site
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-3">
        4. Payments, Fees, and Hawaii General Excise Tax (GET)
      </h3>
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          As a business operating in Hawaii, we are subject to the Hawaii General Excise Tax (GET).
          This is a tax on the gross income received by a business for the privilege of doing
          business in Hawaii. It is not a sales tax on the customer. We may visibly pass on the cost
          of the GET to you, as is a common practice in Hawaii, and this will be added to your
          invoices as required. The GET rate for services is typically 4.712% (4% state + 0.5% Oahu
          county surcharge + applicable district surcharges).
        </li>
      </ul>
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-3">7. Termination</h3>
      <p>
        We may terminate or suspend your access to our services immediately, without prior notice or
        liability, for any reason whatsoever, including without limitation if you breach the Terms.
        Upon termination, your right to use the services will cease immediately. You may terminate
        services by providing 30 days written notice. In the event of termination by either party,
      ...
      <p>
        ...
        Hawaii, without regard to its conflict of law principles. Any disputes arising under or in
        connection with these Terms shall be resolved through binding arbitration in accordance with
        the rules of the American Arbitration Association, conducted in Honolulu, Hawaii.
        Notwithstanding the foregoing, either party may seek injunctive relief in the state or
        federal courts located in Honolulu, Hawaii.
      </p>

      <h3 className="text-xl font-bold text-white mt-6 mb-3">9. Changes to Terms</h3>
      <p>
        We reserve the right to modify these Terms at any time. We will notify you of any changes by
        posting the new Terms on this page and updating the "Effective Date" at the top. Your
        continued use of our services after any such changes constitutes your acceptance of the new
        Terms.
      </p>
      ...
      <p>
        ...
        shall be replaced with a valid and enforceable provision that most closely approximates the
      ...
      <p className="font-semibold">
        ...
        FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. SILVA AUTOMATION MAKES NO WARRANTY
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-3">15. Contact Information</h3>

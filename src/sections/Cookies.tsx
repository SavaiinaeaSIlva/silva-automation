export default function Cookies() {
  return (
    <div className="legal-content">
      ...
      <p>
        <strong>Essential Cookies:</strong> These cookies are strictly necessary for the operation
        of our website. They enable core functions such as website navigation, access to secure
        areas, and basic site functionality. The website cannot function properly without these
        cookies.
      </p>
      ...
      <p>
        ...
        their settings preferences. You can typically:
      </p>
      ...
      <p>
        ...
        consent banner allowing you to accept or decline non-essential cookies.
      </p>

      <p>
        <strong>Popular Browser Cookie Management:</strong>
      </p>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-3">5. Impact of Disabling Cookies</h3>
      <p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          <strong>Essential cookies:</strong> Retained as needed for site functionality
        </li>
      </ul>

      <h3 className="text-xl font-bold text-white mt-6 mb-3">7. Updates to This Cookie Policy</h3>
      <p>
        We may update this Cookie Policy from time to time to reflect changes in our practices,
        technology, legal requirements, or for other operational reasons. Please revisit this page
        periodically to stay informed about our use of cookies. The "Effective Date" at the top
        indicates when the policy was last updated.
      </p>

      <h3 className="text-xl font-bold text-white mt-6 mb-3">8. Contact Us</h3>
      <p>

      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 w-full">
            ...
            <div className="relative p-8 md:p-10 rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="flex-1">
                    ...
                    <p className="text-blue-100/70 text-base max-w-2xl">
                        Unlike "all-in-one" CRMs, you own the <strong>entire source code</strong> and architecture of your automation. If you move teams or change tools, your infrastructure moves with you. No lock-in, no "data ransoms," ever.
                    </p>
                </div>
        ...
        <div className="mt-12 text-center">
            <p className="text-blue-200/50 text-xs flex items-center justify-center gap-2">
                <BarChart3 size={14} />
                Most teams see a full ROI within the first 4-6 months of implementation.
            </p>
        </div>
      </div>
    </section>
